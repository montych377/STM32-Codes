...
/* USER CODE BEGIN PV */
uint16_t Pin[] = {L0_Pin,L1_Pin,L2_Pin,L3_Pin,L4_Pin,L5_Pin,L6_Pin,L7_Pin,L8_Pin,L9_Pin,L10_Pin,L12_Pin,L13_Pin,L14_Pin,L15_Pin};
char arr[20];
/* USER CODE END PV */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOB, L0_Pin|L1_Pin|L2_Pin|L10_Pin
                          |L12_Pin|L13_Pin|L14_Pin|L15_Pin
                          |L3_Pin|L4_Pin|L5_Pin|L6_Pin
                          |L7_Pin|L8_Pin|L9_Pin, GPIO_PIN_RESET);
