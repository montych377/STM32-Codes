...
osThreadId WhiteLEDHandle;
/* USER CODE BEGIN PV */

unsigned char arr1[] = "LED 1 is ON\r\n";
unsigned char arr2[] = "LED 2 is ON\r\n";
unsigned char arr3[] = "LED 3 is ON\r\n";
unsigned char arr4[] = "LED 4 is ON\r\n";
...
int main(void)
{
  ...
  /* definition and creation of WhiteLED */
  osThreadDef(WhiteLED, StartWhiteLED, osPriorityNormal, 0, 128);
  WhiteLEDHandle = osThreadCreate(osThread(WhiteLED), NULL);
...
/* USER CODE BEGIN Header_StartWhiteLED */
/**
* @brief Function implementing the WhiteLED thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_StartWhiteLED */
void StartWhiteLED(void const * argument)
{
  /* USER CODE BEGIN StartWhiteLED */
  /* Infinite loop */
  for(;;)
  {
