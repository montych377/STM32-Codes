...
uint8_t counter = 0;
uint8_t flag = 0;
uint8_t LED_Pins[] = {0x00,0x01,0x02,0x04,0x08,0x10,0x20,0x40,0x80};
...
//
//		  if(counter == 7){
//		  			  HAL_GPIO_WritePin(GPIOB, LED7_Pin, 1);
//		  		  }
//
//		  if(counter == 8){
//		  			  HAL_GPIO_WritePin(GPIOB, LED8_Pin, 1);
//		  		  }
//		  if(counter == 9){
...
//						HAL_GPIO_WritePin(GPIOB, LED7_Pin, 0);
...
//		  		  }
	  ...
	  HAL_GPIO_WritePin(GPIOB, LED_Pins[counter], 1);
